...
//       // const response = await updatesStatusHomeStay({
//       //   idHomestay: propertyId,
//       //   status: newStatus,
//       // })
//       // if (response.success) {
...
//       // }
//       console.log(
//         "Status change not implemented yet",
//         propertyId,
//         currentStatus
//       );
//     } catch (error) {
...
//             </TableHeader>
//             <TableBody>
//               {getCurrentPageData().map((property: any) => (
...
//                       size="sm"
//                       onClick={() =>
//                         handleStatusChange(property._id, property.status)
//                       }
//                     >
//                       {property.status === "hoạt động"
//                         ? "Dừng Hoạt động"
