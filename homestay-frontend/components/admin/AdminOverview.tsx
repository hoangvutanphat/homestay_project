...
export function AdminOverview() {
  ...
  const [totalAnalysis, setTotalAnalysis] = React.useState<any>(null);
        ...
        <div className="space-y-6">
          ...
          <Card className="col-span-4">
            <CardHeader>
              ...
              <CardDescription>
                Biểu đồ thống kê số lượng đặt phòng theo từng tháng trong năm
                2023
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-8">
                {totalAnalysis.topHomestays.map((property: any) => (
                  <div
                    key={property.homestayDetails._id}
                    className="flex items-center"
                  >
                    <div className="w-9 h-9 rounded bg-gray-200 mr-4"></div>
                    <div className="space-y-1 flex-1">
                      <p className="text-sm font-medium leading-none">
                        {property.homestayDetails.name}
                      </p>
                      <p className="text-sm text-muted-foreground">
                        {property.homestayDetails.address}
                      </p>
                    </div>
                    <div className="text-sm text-right">
                      <p className="font-medium">
                        {property.bookingCount} lượt đặt
                      </p>
                      <p className="text-muted-foreground">
                        {property.homestayDetails.averageRating} sao
                      </p>
                    </div>
                  </div>
                ))}
