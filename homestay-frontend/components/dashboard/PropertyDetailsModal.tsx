...
//     booked: 3,
//   },
//   [format(new Date().setDate(new Date().getDate() + 3), 'yyyy-MM-dd')]: {
//     available: 0,
//     booked: 4,
//   },
// }
...
//   const currentAvailability = availabilityData[formattedSelectedDate] || {
//     available: 0,
//     booked: 0,
//   }
...
//       const responseInfoRoom = await getCheckAvailabilityHomestay({
...
//                         <span className='font-medium'>
//                           {infoRoom.availableRooms}
//                         </span>
//                       </div>
//                       <div className='flex justify-between items-center'>
//                         <span>Số phòng đã đặt:</span>
//                         <span className='font-medium'>
//                           {infoRoom.bookedRooms === undefined
//                             ? 0
//                             : infoRoom.bookedRooms.length}
//                         </span>
//                       </div>
//                     </div>
//                   </>
