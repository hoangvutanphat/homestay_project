...
const destinations = [
  {
    ...
    properties: 1250,
    image:
      "https://images.unsplash.com/photo-1509233725247-49e657c54213?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    trending: true,
  ...
  },
  {
    ...
    properties: 920,
    image:
      "https://images.unsplash.com/photo-1562602833-0f4ab2fc46e3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    trending: true,
...
const DestinationCard = ({ destination }: { destination: Destination }) => (
  <Card className="group overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer h-full">
    <div className="relative">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t group-hover:scale-110 transition-transform duration-500 from-black/60 via-transparent to-transparent"></div>
    ...
    <section className="container py-20 px-6 md:px-20 relative overflow-hidden">
      <div className="text-center mb-16 relative z-10">
        <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full mb-4">
          ...
          <span className="text-blue-600 font-semibold">Điểm đến hot</span>
        </div>
        <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4 leading-tight pb-2">
          Điểm đến phổ biến
        </h2>
