...
import { ArrowRight, Calendar, Clock, Gift, Sparkles } from "lucide-react";
...
const OfferCard = ({ offer }: { offer: (typeof offers)[0] }) => (
  <Card className="group overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 bg-white/80 backdrop-blur-sm">
    <div className="relative">
      ...
      <div
        className={`absolute inset-0 bg-gradient-to-br ${offer.color} opacity-75 group-hover:opacity-85 transition-opacity duration-300`}
      ></div>
    ...
    <CardContent className="p-8 relative">
      <div
        className={`absolute inset-0 bg-gradient-to-br ${offer.bgGradient} opacity-30 rounded-b-lg`}
      ></div>
    ...
    <section className="container py-24 relative overflow-hidden">
      ...
      <div className="text-center mb-20 relative z-10">
        <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-100 via-pink-50 to-purple-100 rounded-full mb-6 shadow-lg border border-purple-200/50">
          ...
          <span className="text-purple-700 font-bold tracking-wide">
            Ưu đãi đặc biệt
          </span>
