...
//                   Địa chỉ: {invoiceData.homestay.address}
//                 </p>
...
//                   <span>{invoiceData.guestName || 'Chưa cập nhật'}</span>
//                 </div>
//                 <div className='flex items-center'>
//                   <MapPin className='h-4 w-4 mr-2 text-muted-foreground' />
//                   <span className='font-medium mr-2'>Địa chỉ:</span>
//                   <span>{invoiceData.guestAddress || 'Chưa cập nhật'}</span>
//                 </div>
//                 <div className='flex items-center'>
//                   <Phone className='h-4 w-4 mr-2 text-muted-foreground' />
//                   <span className='font-medium mr-2'>Số điện thoại:</span>
//                   <span>{invoiceData.guestPhone || 'Chưa cập nhật'}</span>
//                 </div>
//               </div>
//             </div>
