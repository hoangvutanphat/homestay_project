...
const PropertyCharacteristics = ({
  ...
  const getIcon = (characteristic: string) => {
    ...
    if (
      lowercased.includes('yên tĩnh') ||
      lowercased.includes('yen tinh') ||
      lowercased.includes('tĩnh')
    ) {
    ...
    if (
      lowercased.includes('thiên nhiên') ||
      lowercased.includes('cây xanh') ||
      lowercased.includes('xanh')
    ) {
  ...
  return (
    <div className='mt-6 p-4 rounded-lg border bg-white mb-3'>
