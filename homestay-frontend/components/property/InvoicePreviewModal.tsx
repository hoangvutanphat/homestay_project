          ...
          <CardContent className='p-6 space-y-6'>
            ...
            <div>
              ...
              <div className='bg-muted rounded-lg p-4'>
                <p className='font-medium text-lg'>
                  {bookingDetails.homestay.name} ({bookingDetails.invoiceCode})
                </p>
            ...
            <div className='bg-blue-50 p-4 rounded-lg'>
              <p className='text-sm text-blue-800'>
                <strong>Lưu ý:</strong> Hóa đơn này chỉ là bản xem trước. Hóa
                đơn chính thức sẽ được gửi sau khi thanh toán thành công.
              </p>
            </div>
          </CardContent>
        </Card>
