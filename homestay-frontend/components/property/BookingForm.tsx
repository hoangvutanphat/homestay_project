...
// import { AlertCircle, CalendarIcon, Star, Users, Bed } from 'lucide-react'
...
//   const nights =
//     checkIn && checkOut ? Math.max(differenceInDays(checkOut, checkIn), 1) : 0
...
//       } else {
//         toast.error(
//           response.error || 'Có lỗi xảy ra khi đặt phòng. Vui lòng thử lại sau.'
//         )
//       }
//     } catch (error) {
...
//           toast.error(
//             'Ngày bạn chọn đã có người đặt rồi. Vui lòng chọn ngày khác.'
//           )
//         } else {
//           toast.error(
//             response.error ||
...
//                 {price.toLocaleString('vi-VN')}đ x {nights} đêm
//               </span>
